...
/* import { sendOrderStatusEmail } from '../utils/emailService.js'; */ // Remove import
...
export const updateOrderStatus = async (req, res) => {
    try {
        ...
        /*
        // If you implement email service, uncomment this:
        try {
            await sendOrderStatusEmail(order.user.email, `Order #${order._id} Status Updated`, `Your order status has been updated to ${status}`);
        } catch (emailError) {
